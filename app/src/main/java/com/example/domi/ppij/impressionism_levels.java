...
public class impressionism_levels extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Boolean unLocked = prefs.getBoolean("unlocked_impressionism_2",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_impressionism_3",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_impressionism_4",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_impressionism_5",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_impressionism_6",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_impressionism_7",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_impressionism_8",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_impressionism_9",true);//TODO set false
        if(unLocked) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_impressionism_levels, menu);
        return true;
    }
