...
public class expressionism_levels extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Boolean unLocked = prefs.getBoolean("unlocked_expressionism_2",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_expressionism_3",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_expressionism_4",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_expressionism_5",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_expressionism_6",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_expressionism_7",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_expressionism_8",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_expressionism_9",true);//TODO set false
        if(unLocked) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_expressionism_levels, menu);
        return true;
    }
