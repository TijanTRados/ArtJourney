...
public class baroque_levels extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Boolean unLocked = prefs.getBoolean("unlocked_baroque_2",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_baroque_3",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_baroque_4",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_baroque_5",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_baroque_6",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_baroque_7",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_baroque_8",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_baroque_9",true);//TODO set false
        if(unLocked) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_baroque_levels, menu);
        return true;
    }
