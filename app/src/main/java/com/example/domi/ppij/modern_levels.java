...
public class modern_levels extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Boolean unLocked = prefs.getBoolean("unlocked_modern_2",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_modern_3",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_modern_4",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_modern_5",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_modern_6",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_modern_7",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_modern_8",true);//TODO set false
        if(unLocked) {
        ...
        unLocked = prefs.getBoolean("unlocked_modern_9",true);//TODO set false
        if(unLocked) {
